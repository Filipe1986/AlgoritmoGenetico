...
public class SelecaoPorTorneio {
	...
	public Individuo cruzamentoPorTorneio(Individuo pai, Individuo mae, int quantidadeTrocaDeGenes) {
		...
		if (filho.getModuloFitness() < pais[melhorIndividuo].getModuloFitness()) {
			System.out.println("Fitnesse filho de um cruzamento " + filho.getFitnessTamanho());
			return filho;
		} else {

			System.out.println(
					"Fitnesse pai com fitness melhor que o filho " + pais[melhorIndividuo].getFitnessTamanho());
